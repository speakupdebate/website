			...
			<div className="relative max-w-6xl mx-auto px-4 sm:px-6">
				<div className="py-12 md:py-20">
					...
					<div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
						{/* 1st item */}
						<div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl text-emerald-500">
							<h4 className="text-5xl font-bold leading-snug tracking-tight mb-1">
								300+
							</h4>
							<p className="text-gray-600 text-center text-xl">Students</p>
						</div>
						...
						<div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl text-emerald-500">
							...
							<p className="text-gray-600 text-center text-xl">
								Chapters in 8 states/countries
							</p>
						</div>
						...
						<div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl text-emerald-500">
							...
							<p className="text-gray-600 text-center text-xl">HS Tutors</p>
						</div>
